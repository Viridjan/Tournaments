...
// MC: multi-player card — score input per player
...
// ML: match log — round results with ELO deltas + event banners
...
// Timer resets each round. First-player indicator shown when enabled
