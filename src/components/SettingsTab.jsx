              ...
              <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    dispatch({ type: "SET_FEATURE", key: "timerMinutes", value: v === "" ? "" : isNaN(Number(v)) ? v : Number(v) });
                  }}
                  style={{ ...S.input, width: 44, textAlign: "center", fontSize: 13, padding: "3px 5px" }}
                />
