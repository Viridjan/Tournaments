...
//   Players: ADD_PLAYER, REMOVE_PLAYER, TOGGLE_PAID, ABANDON_PLAYER
...
//   Tournament: START_TOURNAMENT, NEXT_ROUND, END_TOURNAMENT, NEW_GP_SESSION
...
//   Config: TOGGLE_FEATURE (bool), SET_FEATURE (any value)

//   Data: MERGE_ELO_DB, RESTORE_SNAPSHOT, SET_SHEETS_URL
function reducer(st,a){switch(a.type){
//   Prizes: ADD/REMOVE/UPDATE_PRIZE, UPDATE_RANK, SET_ENTRY_COST
case"OPEN_TOURNAMENT":return{...st,screen:"tournament",tournamentId:a.id,activeTab:"players"};
//   Modes: SET_TEST_MODE, SET_EXPERIMENTAL, SET_ADVANCED
case"GO_HOME":return{...st,screen:"landing"};
//   Test: INJECT_TEST_PLAYERS (marks test:true), AUTO_SELECT_WINNERS, FULL_RESET
